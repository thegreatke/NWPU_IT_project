...
<h2 style="text-align: center; color: white; font-family: '华文行楷'; font-size: 500%">图 书 馆（admin）</h2>
    ...
    <script>
        ...
        $("#loginButton").click(function () {
            ...
            if (id == '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "/api/loginCheck_admin_you_cant_find_me_hahaha",
                    data: {
                        id:id ,
                        passwd: passwd
                    },
